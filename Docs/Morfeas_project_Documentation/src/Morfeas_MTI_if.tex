...
The \texbf{new\_RF\_CH} argument give the information on the radio channel that the MTI will be tuned. Must be an even number between 0 and 126.

The \texbf{new\_mode} argument is controlling the mode of the MTI's radio and modem. This must have one of the values that showed above. The mode "Disable"
