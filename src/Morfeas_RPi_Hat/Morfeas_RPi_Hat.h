/*
Program: Morfeas_RPi_Hat.h  Declaration of functions related to Morfeas_RPi_Hat.
...
//Read value to Morfeas_RPi_Hat LED, return value of the LED, or -1 on read failure.
